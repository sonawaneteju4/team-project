    ...
    <div>
      ...
      <div className="userDetail">
        <div className="info1">
          <div> 
           <span className="***">
            </span> Hospital Name :{hospData.hospName}
            </div>
          <div> 
           <span className="***">
            </span> Email :{hospData.email}
            </div>
          <div> 
           <span className="***">
            </span> Id :{hospData.uId}
            </div>
          <div> 
           <span className="***">
            </span> Category :{hospData.type}
            </div>
          <div> 
           <span className="***">
            </span> Address:{hospData.address}
            </div>
        </div>
        <div className="info1">
          <div> 
           <span className="***">
            </span> Contact:{hospData.contact}
            </div>
          <div> 
           <span className="***">
            </span> State :{hospData.state}
            </div>
          <div> 
           <span className="***">
            </span> City:{hospData.city}
            </div>
          <div> 
           <span className="***">
            </span> District :{hospData.district}
            </div>
          <div> 
           <span className="***">
            </span> pincode :{hospData.pincode}
            </div>
        </div>
      </div>
