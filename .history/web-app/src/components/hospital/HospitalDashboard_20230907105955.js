  ...
  return (
    <div>
      ...
      <div className="userDetail">
        <div className="info1">
          <div> 
            Hospital Name :{hospData.hospName}</div>
          <div> 
            Email :{hospData.email}</div>
          <div> 
            Id :{hospData.uId}</div>
          <div> 
            Category :{hospData.type}</div>
          <div> 
            Address:{hospData.address}</div>
        </div>
        <div className="info1">
          <div> 
            Contact:{hospData.contact}</div>
          <div> 
            State :{hospData.state}</div>
          <div> 
            City:{hospData.city}</div>
          <div> 
            District :{hospData.district}</div>
          <div> 
            pincode :{hospData.pincode}</div>
        </div>
      </div>
