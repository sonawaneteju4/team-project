...
const BankDashboard = () => {
  ...
  return (
    <div>
      ...
      <hr />
      <div>
        <Link to="/donationReq">             <img height={"200px"} src="./image/test.png" alt="bank"></img>
           <p className="pOfInof">Donation Req</p>
</Link>
      </div>
      <div>
        <Link to="/createNewReport">            <img height={"200px"} src="./image/test.png" alt="bank"></img>
 <p className="pOfInof">
          Create New Blood Donotion Form
          </p>
          </Link>
      </div>
      <div>
        <Link to="/hospitalReq">            <img height={"200px"} src="./image/test.png" alt="bank"></img>
 <p className="pOfInof">
          Hospital Req
          </p>
          </Link>
      ...
      <div></div>
      <div>
        <Link to="/stockOfBlood">             <img height={"200px"} src="./image/test.png" alt="bank"></img>
<p className="pOfInof">
          Stock
          </p>
          </Link>
