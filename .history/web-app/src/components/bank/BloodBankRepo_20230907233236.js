      ...
      <div className="repoBody">
        ...
        <div className="main">
          <div className="t1">
            ...
            <p>Blood Group : {userReport.BloodGroup}</p>
            <p>HIV : {userReport.HIV}</p>
            <p>Haemoglobin : {userReport.Haemoglobin} : </p>
            <p>Platelet Count : {userReport.BloodBankId}</p>
          </div>
          <div className="t2">
            <p>RBC Count : {userReport.BloodBankId}</p>
            <p>Type OF Donation : {userReport.BloodBankId}</p>
            <p>Date Of Donation : {userReport.BloodBankId}</p>
            <p>Hepatities B : {userReport.BloodBankId}</p>
            <p>Hepatities C : {userReport.BloodBankId}</p>
            <p>Plasma Count : {userReport.BloodBankId}</p>
          </div>
        </div>
      </div>
    </>
