...
const BankDashboard = () => {
  ...
  return (
    <div>
      ...
      <div>
        <Link to="/createNewReport"> <p className="pOfInof">>Create New Blood Donotion Form</Link>
      </div>
      <div>
        <Link to="/hospitalReq"> <p className="pOfInof">>Hospital Req</Link>
      </div>
      <div></div>
      <div>
        <Link to="/stockOfBlood"> <p className="pOfInof">>Stock</Link>
      </div>
