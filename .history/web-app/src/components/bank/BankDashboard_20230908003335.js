...
<span className="spanOfBBTititle"></span>
      ...
      <div className="compDiv">
        <Link to="/donationReq">
          {" "}
          <img height={"160px"} src="./image/blood-extraction.png" alt="bank"></img>
      ...
      <div className="compDiv">
        <Link to="/createNewReport">
          {" "}
          <img height={"160px"} src="./image/newdonor.png" alt="bank"></img>
      ...
      <div className="compDiv">
        <Link to="/stockOfBlood">
          {" "}
          <img height={"160px"} src="./image/stockmanagement.png" alt="bank"></img>
