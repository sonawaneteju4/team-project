      ...
      <div className="userDetail">
        ...
        <div className="">
          <div><span className="snapOfTitile">
            </span>Email :{bankData.email}</div>
          <div><span className="snapOfTitile">
            </span>Name : {bankData.name}</div>
          <div><span className="snapOfTitile">
            </span>Id :{bankData.uId}</div>
          <div><span className="snapOfTitile">
            </span>Address: {bankData.address}</div>
        </div>
        <div>
          <div><span className="snapOfTitile">
            </span>State :{bankData.state}</div>
          <div><span className="snapOfTitile">
            </span>District:{bankData.district}</div>
          <div><span className="snapOfTitile">
            </span>City:{bankData.city}</div>
          <div><span className="snapOfTitile">
            </span>Contact:{bankData.contact}</div>
          <div><span className="snapOfTitile">
            </span>Category :{bankData.category}</div>
        </div>
      </div>
      <hr />
      <div>
