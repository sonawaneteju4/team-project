...
span.snapOfTit        </div>
      ...
      <div className="userDetail">
        ...
        <div className="">
          <div>span.snapOfTitEmail :{bankData.email}</div>
          <div>span.snapOfTitName : {bankData.name}</div>
          <div>span.snapOfTitId :{bankData.uId}</div>
          <div>span.snapOfTitAddress: {bankData.address}</div>
        </div>
        <div>
          <div>span.snapOfTitState :{bankData.state}</div>
          <div>span.snapOfTitDistrict:{bankData.district}</div>
          <div>span.snapOfTitCity:{bankData.city}</div>
          <div>span.snapOfTitContact:{bankData.contact}</div>
          <div>span.snapOfTitCategory :{bankData.category}</div>
        </div>
      </div>
      <hr />
      <div>
