...
span.        </div>
      ...
      <div className="userDetail">
        ...
        <div className="">
          <div>span.Email :{bankData.email}</div>
          <div>span.Name : {bankData.name}</div>
          <div>span.Id :{bankData.uId}</div>
          <div>span.Address: {bankData.address}</div>
        </div>
        <div>
          <div>span.State :{bankData.state}</div>
          <div>span.District:{bankData.district}</div>
          <div>span.City:{bankData.city}</div>
          <div>span.Contact:{bankData.contact}</div>
          <div>span.Category :{bankData.category}</div>
        </div>
      </div>
      <hr />
      <div>
