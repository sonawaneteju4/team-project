      ...
      <div>
        ...
        {donorHistory.currentlysuffereing === "Yes" && (
          <div>
            ...
            <lable>Cold</lable>
            <select className="dselect" name="cold" id="" onChange={handleChange}>
          <option value="">Select</option>
          <option value="Yes">Yes</option>
          <option value="No">No</option>
          </select>
            <lable>Flue</lable>
            <select className="dselect" name="flue" id="" onChange={handleChange}>
          <option value="">Select</option>
          <option value="Yes">Yes</option>
          <option value="No">No</option>
          </select>            <lable>covid</lable>
            <input type="text" name="" id="" />
            <lable>dibeties</lable>
            <select className="dselect" name="dibeties" id="" onChange={handleChange}>
          <option value="">Select</option>
          <option value="Yes">Yes</option>
          <option value="No">No</option>
          </select>          </div>
