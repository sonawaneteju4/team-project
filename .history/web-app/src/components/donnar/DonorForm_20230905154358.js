...
<>
  ...
  <label htmlFor="">Have you donate blood before?</label>
            <input type="checkbox" name="donatebloodbefore" onChange={handleChange} />
  ...
  <label htmlFor="">Have you done any blood test before ?</label>
            <input type="checkbox" name="bloodtestbefore" onChange={handleChange} />

  </div>
  <div>
  <label htmlFor="">Have you suffering from any disease ?</label>
            <input type="checkbox" name="currentlysuffereing" onChange={handleChange} />
