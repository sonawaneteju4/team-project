            ...
            <div> 
              <span className="spanOftitile">
               ...
               Blood Group:
                ...
                {userData.bloodGroup}</div>
            <div> 
              <span className="spanOftitile">
               Weight :
              </span>
               {userData.weight} Kg</div>
          </div>
          <div className="info1">
            <div> 
              <span className="spanOftitile">
               ...
               <Contact></Contact> :{userData.mobile}</div>
            <div> 
              <span className="spanOftitile">
            ...
            <div> 
              <span className="spanOftitile">
               ...
               <Distric></Distric>t :{userData.dist}</div>
            <div> 
              <span className="spanOftitile">
          ...
          <div className="info1">
            <div> 
              <span className="spanOftitile">
               ...
               <Pincode></Pincode> :{userData.pincode}</div>
            <div> 
              <span className="spanOftitile">

              </span>
               <Aadhar:></Aadhar:> {userData.aadhar}</div>
            <div> 
              <span className="spanOftitile">

              </span>
               <Address></Address>: {userData.address}</div>
          </div>
