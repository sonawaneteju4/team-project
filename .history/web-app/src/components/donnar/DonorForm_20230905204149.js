...
const DonorForm = () => {
  ...
  return (
    <div className="dhForm">
      ...
      <div>
        <label className="dlabel"  htmlFor="">Have you donate blood before?</label>
         <select className="dselect"  name="donatebloodbefore" id="" onChange={handleChange}>
          <option value="">Select</option>
          <option value="">Yes</option>
          <option value="">No</option>
        </select>
      </div>
     {donorHistory.donatebloodbefore === "Yes" && (<div>
        <label className="dlabel"  htmlFor="">Last Donate Date </label>
        <input type="date" name="lastdonatedate" onChange={handleChange} />
      </div>)}
      <div>
        <label className="dlabel"  htmlFor="">Have you done any blood test before ?</label>
      ...
      <div>
        <label className="dlabel"  htmlFor="">Have you suffering from any disease ?</label>
         <select className="dselect"  name="" id="">
          <option value="">Select</option>
          <option value="">Yes</option>
          <option value="">No</option>
