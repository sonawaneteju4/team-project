    ...
    <div className="dhForm">
      ...
      <div>
       ...
       {donorHistory.bloodtestbefore === 'Yes' && (<div>
        ...
        <select className="dselect" name="cbc" id="" onChange={handleChange}>
          <option value="">Select</option>
          <option value="Yes">Yes</option>
          <option value="No">No</option>
          </select>
          <lable>HIV (if Yes Then Only Click Yes)</lable>
          <select className="dselect" name="hiv" id="" onChange={handleChange}>
          <option value="">Select</option>
          <option value="Yes">Yes</option>
          <option value="No">No</option>
          </select>          <lable>Hephities B</lable>
          <select className="dselect" name="hephitiesb" id="" onChange={handleChange}>
          <option value="">Select</option>
          <option value="Yes">Yes</option>
          <option value="No">No</option>
          </select>          <lable>Hephities C</lable>
