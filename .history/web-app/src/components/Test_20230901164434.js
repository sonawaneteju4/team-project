  ...
  return (
    <div className="container">
      <div className="card">
        ...
        {!regModal && (
            <>
              <button className="button1"onClick={handleStateC}>Crete New Account</button>
            </>
          )}
          {! loginModal && (
            <>
                        <button className="button1"onClick={handleState}>Log in </button>
            </>
          )}
          ...
          {/* <button className="button1"onClick={register}>Create User</button> */}
